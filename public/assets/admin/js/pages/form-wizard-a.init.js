             ...
             transitionEffect: "slideLeft", onStepChanging: function (t, i, e) {
                 ...
                 onFinishing: function (t, i) {
                    ...
                    onFinished: function (t, i) {
                        ...
                        $.ajax({
                            type : 'POST',
                            url : "/reservation-aeroport",
                            data: $('#wizard-validation-form-3').serialize(),
                            success:function(data){
                                $('#wizard-validation-form-3').find('a[href="#finish"]').remove();
                                $('#wizard-validation-form-3').find('a[href="#previous"]').remove();
                                $('#wizard-validation-form-3 #steps-uid-0 .actions ul li:last-child').append('<div class="spinner-border" role="status"><span class="sr-only">Loading...</span></div>');
                    ...
                    this.createValidatorForm(e("#wizard-validation-form-3")),
