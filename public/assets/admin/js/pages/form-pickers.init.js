$(function(){
    ...
    $("#timepicker2").timepicker({
        showMeridian:!1,icons:{
            up:"fa fa-angle-up",
            down:"fa fa-angle-down"
        }
    });
    $("#timepicker2r").timepicker({
        showMeridian:!1,icons:{
            up:"fa fa-angle-up",
            down:"fa fa-angle-down"
        }
    });
    $("#timepicker2v").timepicker({
        showMeridian:!1,icons:{
            up:"fa fa-angle-up",
            down:"fa fa-angle-down"
        }
    });
    $("#timepicker2r_v").timepicker({
        showMeridian:!1,icons:{
            up:"fa fa-angle-up",
            down:"fa fa-angle-down"
        }
    });
    // $("#timepicker2f").timepicker({
    //     showMeridian:!1,icons:{
    //         up:"fa fa-angle-up",
    //         down:"fa fa-angle-down"
    //     }
    // }),
    $("#timepicker2m").timepicker({
        showMeridian:!1,icons:{
            up:"fa fa-angle-up",
            down:"fa fa-angle-down"
        }});
    $("#timepicker2m_v").timepicker({
        showMeridian:!1,icons:{
            up:"fa fa-angle-up",
            down:"fa fa-angle-down"
        }});
    ...
    //         },
    //         opens:"left",drops:"down",buttonClasses:["btn","btn-sm"],applyClass:"btn-success",
    //         cancelClass:"btn-secondary",separator:" to ",
    //         locale:{
