             ...
             transitionEffect: "slideLeft", onStepChanging: function (t, i, e) {
                 ...
                 onFinishing: function (t, i) {
                    ...
                    onFinished: function (t, i) {
                        ...
                        $.ajax({
                            type : 'POST',
                            url : "/partenaire/reservation-aeroport-v",
                            data: $('#wizard-va-validation-form').serialize(),
                            success:function(data){
                                location.href = "/partenaire/reservation-aeroport";
                            }
                        });
                    } }), n
                    ...
                    this.createValidatorForm(e("#wizard-va-validation-form")),
